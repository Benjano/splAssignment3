...
public class RentalRequestTesting {
	...
	public void setUp() throws Exception {
		...
		asset2 = new AssetImpl("Nir's House", "Hut",new Location(10, 15), 100, 1);
	...
	public void getStatus(){
		assertEquals("blabla", RequestStatus.Incomplete , rentalRequest.getStatus());	
	}
	
	@Test
	public void setRentalRequestStatus(){
		rentalRequest.setRentalRequestStatus(RequestStatus.InProgress);
		assertEquals("blabla", RequestStatus.InProgress , rentalRequest.getStatus());	
	}
