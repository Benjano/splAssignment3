...
public class CustomerGroupDetailsTesting {
	...
	public void testAddCustomer() {
		...
		Customer customer2 = new CustomerImpl("Aviv", VandalismType.None , 20, 60);
		assertEquals("Customer Group Details Contains a wrong number of rental requests ", group1.getCustomer(0), customer2);
	}
	...
	public void testGetRentalRequest() {
		...
		assertEquals("the rental Requests are not the same", group1.getRentalRequest(0), rentalRequest2);
